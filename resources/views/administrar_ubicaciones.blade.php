        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-4 mb-4 d-flex">
                <div class="card p-4 custom-card-style flex-grow-1 d-flex flex-column">
                    <h5 class="card-title" style="color: #a0522d;">Ubicaciones existentes</h5>
                    ...
                    <?php 
                        ...
                        $Items = [
                            ['id' => 1, 'ubicacion' => 'Bogota'],
                            ['id' => 2, 'ubicacion' => 'Medellin'],
                            ['id' => 3, 'ubicacion' => 'Direccion 123#'],
                            ['id' => 4, 'ubicacion' => 'Puto el que lo lea'],
                        ];
                    ?>
                        ...
                        @if(isset($Items) && count($Items) > 0)
                            ...
                            @foreach ($Items as $items)
                                ...
                                <div class="user-card d-flex justify-content-between align-items-center mb-2 p-3"
                                    ...
                                    onclick="window.location='{{ route('administrador.ubicaciones.edit') }}'"> 
                                    <strong class="log-username text-muted">Ubicacion: {{ $items['ubicacion'] }} (Ejemplo)</strong>
                                </div>
                            @endforeach
                        @endif
                    </div>
