...
<x-app-layout> 
    ...
    <div class="container mt-4">
        ...
        <h2 class="mb-4" style="color: #622D16;">Administración de Ubicaciones</h2> 
        
        {{-- FILA PRINCIPAL DE 3 COLUMNAS --}}
        <div class="row justify-content-center">
            <div class="col-md-3 mb-4">
                <div class="card p-4 custom-card-style-create d-flex flex-column align-items-center">
                    <h5 class="card-title w-100" style="color: #a0522d;">Creación de Ubicaciones</h5>
                    <form id="createUserForm" action="{{ route('administrador.ubicacion.store') }}" method="POST">
                        @csrf
                        <div class="w-100 text-left mb-4">
                            <div class="mb-4 form-group-with-icon">
                                ...
                                <input id="ubicacion" class="form-control login-input transparent-input-bottom-border" type="text" name="ubicacion" value="{{ old('ubicacion') }}" placeholder="" required />
                                @error('ubicacion')
                ...
                <div class="card p-4 custom-card-style flex-grow-1 d-flex flex-column">
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <div class="input-group flex-grow-1 me-2">
                            ...
                            <input type="text" id="searchInputUbicacion" class="form-control custom-search-input-historial" placeholder="Buscar" aria-label="Buscar" style="border-color: #ff9800; box-shadow: none;">
                        </div>
                    </div>
                    <div class="access-list-container flex-grow-1 overflow-auto" id="accessListContainer">
                        @include('partials.ubicacion_buscar', ['ubicaciones' => $ubicaciones])
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content custom1-card-style p-4">
                <div class="modal-body text-center">
                    ...
                    <h5 class="mb-4" style="color: #622D16;">¿Está seguro que quiere registrar esta ubicación?</h5>
                    <div class="d-flex justify-content-center gap-3">
                        <button type="button" class="btn btn-custom-action" id="confirmCreateUser">Registrar ubicación</button>
...
<script>
    $(document).ready(function() {
        ...
        $('#searchInputUbicacion').on('keyup', function() {
            var searchTerm = $(this).val(); // Obtiene el texto actual
            $.ajax({
                url: '{{ route('administrador.ubicacion.buscar') }}', // **Usamos la ruta definida en web.php**
                method: 'GET',
                data: {
                    search: searchTerm
